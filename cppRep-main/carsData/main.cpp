/*
    TRABALHO 1 - AEDS 2 - 01 Gerenciador de Busca de Carros, Vans e Utilitários -
    OTAVIO FERREIRA DE BRITO SILVEIRA RA:2022.1.08.O23
    ALICIA GARNIER DUARTE FRANCO RA:2022.1.08.001
*/
#include <fstream>
#include <iomanip>
#include <iostream>
